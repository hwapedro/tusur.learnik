...
export const CheckButtonStyled = styled(ButtonStyled) <{ disabled?: boolean }>`
  ...
  ${({ disabled }: { disabled?: boolean }) =>
    disabled &&
    css`
      border-color: ${(props) => props.theme.commonText};
      color: ${(props) => props.theme.commonText};
...
export const CloseButtonStyled = styled.div`
  ...
  background-image: url("data:image/svg+xml,%3Csvg width='50' height='50' viewBox='0 0 35 35' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M16.192 6.34399L11.949 10.586L7.70697 6.34399L6.29297 7.75799L10.535 12L6.29297 16.242L7.70697 17.656L11.949 13.414L16.192 17.656L17.606 16.242L13.364 12L17.606 7.75799L16.192 6.34399Z'  fill='%23F45B69'/%3E%3C/svg%3E%0A");
